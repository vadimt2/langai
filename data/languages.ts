...
const languagesList: Language[] = [
  ...
  { code: "az", name: "Azerbaijani", nativeName: "azərbaycan dili", countryCode: "az" },
  { code: "bm", name: "Bambara", nativeName: "bamanankan", countryCode: "ml" },
  { code: "ba", name: "Bashkir", nativeName: "башҡорт теле", countryCode: "ru" },
  ...
  { code: "bs", name: "Bosnian", nativeName: "bosanski jezik", countryCode: "ba" },
  { code: "br", name: "Breton", nativeName: "brezhoneg", countryCode: "fr" },
  { code: "bg", name: "Bulgarian", nativeName: "български език", countryCode: "bg" },
  ...
  { code: "ce", name: "Chechen", nativeName: "нохчийн мотт", countryCode: "ru" },
  ...
  { code: "fj", name: "Fijian", nativeName: "vosa Vakaviti", countryCode: "fj" },
  ...
  { code: "ht", name: "Haitian", nativeName: "Kreyòl ayisyen", countryCode: "ht" },
  ...
  { code: "ia", name: "Interlingua", nativeName: "Interlingua", countryCode: "eu" },
  { code: "id", name: "Indonesian", nativeName: "Bahasa Indonesia", countryCode: "id" },
  { code: "ie", name: "Interlingue", nativeName: "Interlingue", countryCode: "eu" },
  ...
  { code: "kl", name: "Kalaallisut", nativeName: "kalaallisut", countryCode: "gl" },
  ...
  { code: "rw", name: "Kinyarwanda", nativeName: "Ikinyarwanda", countryCode: "rw" },
  ...
  { code: "lt", name: "Lithuanian", nativeName: "lietuvių kalba", countryCode: "lt" },
  { code: "lu", name: "Luba-Katanga", nativeName: "Kiluba", countryCode: "cd" },
  { code: "lv", name: "Latvian", nativeName: "latviešu valoda", countryCode: "lv" },
  { code: "gv", name: "Manx", nativeName: "Gaelg", countryCode: "im" },
  { code: "mk", name: "Macedonian", nativeName: "македонски јазик", countryCode: "mk" },
  { code: "mg", name: "Malagasy", nativeName: "Malagasy fiteny", countryCode: "mg" },
  ...
  { code: "mh", name: "Marshallese", nativeName: "Kajin M̧ajeļ", countryCode: "mh" },
  { code: "mn", name: "Mongolian", nativeName: "монгол", countryCode: "mn" },
  { code: "na", name: "Nauru", nativeName: "Ekakairũ Naoero", countryCode: "nr" },
  { code: "nv", name: "Navajo", nativeName: "Diné bizaad", countryCode: "us" },
  { code: "nb", name: "Norwegian Bokmål", nativeName: "Norsk bokmål", countryCode: "no" },
  { code: "nd", name: "North Ndebele", nativeName: "isiNdebele", countryCode: "zw" },
  { code: "ne", name: "Nepali", nativeName: "नेपाली", countryCode: "np" },
  { code: "ng", name: "Ndonga", nativeName: "Owambo", countryCode: "na" },
  { code: "nn", name: "Norwegian Nynorsk", nativeName: "Norsk nynorsk", countryCode: "no" },
  { code: "no", name: "Norwegian", nativeName: "Norsk", countryCode: "no" },
  { code: "ii", name: "Nuosu", nativeName: "ꆈꌠ꒿ Nuosuhxop", countryCode: "cn" },
  { code: "nr", name: "South Ndebele", nativeName: "isiNdebele", countryCode: "za" },
  { code: "oc", name: "Occitan", nativeName: "Occitan", countryCode: "fr" },
  { code: "oj", name: "Ojibwe", nativeName: "ᐊᓂᔑᓈᐯᒧᐎᓐ", countryCode: "ca" },
  { code: "cu", name: "Old Church Slavonic", nativeName: "ѩзыкъ словѣньскъ", countryCode: "bg" },
  ...
  { code: "rm", name: "Romansh", nativeName: "rumantsch grischun", countryCode: "ch" },
  ...
  { code: "se", name: "Northern Sami", nativeName: "Davvisámegiella", countryCode: "no" },
  { code: "sm", name: "Samoan", nativeName: "gagana faa Samoa", countryCode: "ws" },
  { code: "sg", name: "Sango", nativeName: "yângâ tî sängö", countryCode: "cf" },
  { code: "sr", name: "Serbian", nativeName: "српски језик", countryCode: "rs" },
  { code: "gd", name: "Scottish Gaelic", nativeName: "Gàidhlig", countryCode: "gb" },
  ...
  { code: "st", name: "Southern Sotho", nativeName: "Sesotho", countryCode: "za" },
  ...
  { code: "tl", name: "Tagalog", nativeName: "Wikang Tagalog", countryCode: "ph" },
  ...
  { code: "fy", name: "Western Frisian", nativeName: "Frysk", countryCode: "nl" },
...
export const languages: Language[] = Array.from(new Map(languagesList.map((lang) => [lang.code, lang])).values())
