...
import { Loader2, ImageIcon, Copy, Save, Trash } from "lucide-react"
  ...
  const handleSave = () => {
    if (extractedText && translatedText) {
      addToHistory({
        sourceLanguage,
        targetLanguage,
        sourceText: `[Image] ${extractedText.substring(0, 100)}${extractedText.length > 100 ? "..." : ""}`,
        translatedText,
          ...
          {!imagePreview ? (
            <>
              ...
              >
                ...
                <p className="text-sm text-gray-500 mb-2">
                  {isDragging ? "Drop your image here" : "Drag & drop or click to upload an image"}
                </p>
                <p className="text-xs text-gray-400">Supported formats: JPEG, PNG, GIF, etc. (Max 5MB)</p>
              </div>
            </>
          ) : (
            <div className="space-y-4">
              <div className="flex justify-between items-center">
                ...
                <Button variant="ghost" size="sm" onClick={handleReset} title="Remove image">
                  ...
                  {!translatedText ? (
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="relative">
                        <Textarea value={translatedText} readOnly className="min-h-[100px]" />
