    ...
    if (isRecording) {
      if (recordingTime >= MAX_RECORDING_TIME) {
        ...
        toast({
          ...
          description: "The maximum recording time of 4 minutes has been reached.",
          variant: "default",
        })
      }
    }
  ...
  const handleTranslate = async () => {
    ...
    try {
      ...
      toast({
        ...
        description: error instanceof Error ? error.message : "Failed to translate voice. Please try again.",
        variant: "destructive",
      })
    } finally {
    ...
    <div className="space-y-4 mt-4">
      <div className="flex flex-col items-center space-y-4">
        ...
        <p className="text-sm text-center">
          {isRecording ? "Recording... Speak now" : "Press the microphone button to start recording"}
        </p>
        ...
        {isRecording && (
          <div className="w-full max-w-md space-y-2">
            ...
            <p className="text-xs text-center text-muted-foreground">
              {remainingTime <= 30 ? (
                <span className="text-red-500 font-medium">{remainingTime} seconds remaining</span>
              ) : (
